  ...
  return (dispatch) =>
    defer(() =>
      ...
      .pipe(
        mergeMap(() =>
          defer(() =>
            graphqlService.client.query(FactsMngSharkAttackListing(listingArgs))
          )
        ),
        map((result) =>
          dispatch({
...
export function importSharkAttacks({
  ...
  return (dispatch) =>
    defer(() =>
      graphqlService.client.mutate(FactsMngImportSharkAttacks(importArgs))
    )
      .pipe(
        mergeMap(() =>
          defer(() =>
